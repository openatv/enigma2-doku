...
## Empfang, Verkabelung und Suchmodule – 10. September 2026

- 32 neue Kapitel je Sprache ergänzen den vorhandenen Sat-Einstieg: insgesamt 33 Empfangsseiten. Eigene Navigation und Verweise auf der Startseite sowie im Einstellungsverzeichnis. Manuelle/automatische Suche, Signalfinder, CableScan, Blindscan, FastScan, AutoBouquetsMaker und DAB+ haben eigene Kapitel; Tuner-, Scan-, Positioner-, ABM- und DAB+-Felder sind zusätzlich einzeln nachschlagbar.
- 287 erfasste Formularvarianten in `data/reception-settings.json`: 124 Satconfig, 56 ScanSetup, 20 Positioner, acht CableScan, acht FastScan, 28 ABM, 23 Blindscan, acht DAB+ und zwölf vorhandene allgemeine Tunerfelder. Alle 275 zusätzlichen Referenzpositionen mit eigenen Sprungmarken und lesbaren DE/EN-Beschriftungen geprüft; die zwölf Tunerfelder verweisen auf die bestehende Referenz. Dynamische DAB+-Satellitenhäkchen, DVB-Treibersperre und USB-Diagnose zusätzlich erklärt.
- Quellgrundlage: Enigma2 `fdc9347241245fd18fd0b8bc93727237189c916c`, AutoBouquetsMaker `ba6010b90b57e7ae9f72efbf283955c880c9351c` und Blindscan `35aed6fadf8d2bd2c125237db675d8bae49f349a`. Auf der Box gemeldete Empfangs-/Pluginstände wurden abgeglichen; keine vorhandenen Pluginfunktionen repariert.
- Acht originale SVG-Schaubilder je Sprache für Einfamilienhaus-SAT, DiSEqC, Quattro/Multischalter, Unicable, Kabel/Antenne, SPAUN bei 0/5 V und Motor. Alle 16 gerendert und einzeln visuell geprüft. Der optionale DC-Blocker ist nur im SPAUN-Antennenzweig eingezeichnet. Das bereitgestellte SPAUN-Foto ist bytegleich; Datenblatt-/Fotoabweichungen bei Stromgrenzen werden erläutert.
- Empfangsgrenzen redaktionell korrigiert: OpenATV-Antennenspeisung 5 V; bei einem Tuner können auch DVB-C-/DVB-T-Programme desselben Multiplexes gemeinsam nutzbar sein. DVB-T2-PLP, Treiber, CAM, Demux und Decoder können begrenzen. Ein C/T-Hybrid-Tuner mit Relais empfängt C oder T2 abwechselnd.
- Die Profile `reception-guides` und `reception-tools` erweitern ScreenshotTour auf 29 Profile und 190 Szenen. Werkzeugstand `92de9f0dd414bbf2bf0eb021ea230955b5cfe950`; 41 Tests bestanden. Der Adapter hält Konfigurationscontainer, Wertelisten und Notifier getrennt, restauriert gemeinsame Templates auch bei Schemafehlern und ruft keine globale NIM-/SEC-Initialisierung auf.
- 38 neue native Originalbilder aus den vier vollständigen `rx-c-…-reception-guides`-/`rx-tools-a-…-reception-tools`-Manifesten einzeln geprüft, SHA-256 kontrolliert und importiert. 19 je Sprache, alle mit gestoppter Wiedergabe und Bootlogo. Jedes neue Bild und jedes Schaubild wird im jeweiligen Sprachbereich verwendet. DAB+-Felder sind im installierten deutschen Image teilweise noch Englisch und entsprechend beschriftet.
- Keine Suche, Motorbewegung oder Übernahme der Beispielkonfiguration. Tunerwerte, Sprache/MetrixHD sowie alle geschützten Senderdatenbank-, Bouquet-, Timer-, Mount- und e2MDB-Dateihashes stimmen vor/nachher überein. Einzige Abweichung im geprüften Dateisatz: die vollständige `/etc/enigma2/settings`, die beim GUI-Neustart neu geschrieben wird. Es wird keine Bytegleichheit der gesamten Settings-Datei behauptet. NAS, HDD und aktuelles Image wurden erhalten.
- Beispielwerte sind ausdrücklich getrennt: SCR 1284 MHz im Formular gegenüber 1210/1420 MHz in der Zeichnung, fiktiver USALS-Standort, ABM-Zeitplanung, CableScan-Startwerte, erweiterte DiSEqC-Befehlsfolge und aktivierte terrestrische 5 V. Signalfinder N/A ist keine HF-Messung. Kein praktischer Hotbird-/DiSEqC-, SCR-, Motor-, SPAUN-, Kabel-/Antennen- oder USB-DAB+-Empfangstest; SAT-FBC und Kabel-FBC bleiben für die vereinbarten späteren Hardwaretests offen.

### Website-Prüfungen für Empfang

- Astro-Check: 24 Dateien, keine Fehler, Warnungen oder Hinweise. Die bestehenden elf Node- und acht Python-Tests des Handbuchs bestanden.
- GitHub Pages unter `/enigma2-doku` und Apache unter `/`: je 496 HTML-Dateien mit internen Links, Bildern, Sprungmarken, Sprachpaaren und Suchindex geprüft. Je 231 echte Pagefind-Suchprüfungen bestanden, davon 28 neue Empfangsfälle. Der anfangs fehlende NIT-Erklärungstext im manuellen Suchlauf wurde vor dem erfolgreichen Abschluss ergänzt.
- Deutsche SPAUN-Seite einschließlich Originalfoto, Schaltbild, Beschriftung und Vergrößerungslink sowie englische CableScan-Seite mit nativer Aufnahme in der gebauten Browseransicht geprüft. Englische Menüwege entsprechen „Tuners, Scanning & Reception“.
- Gesamtbestand: 247 Inhalte und 106 bebilderte Kapitel je Sprache, 370 native PNGs (344 Bootlogo, 26 Beispielsender), zusätzlich Web-Editor-Bild, 16 Umbra-Abbildungen, SPAUN-Foto und 16 SVG-Verkabelungszeichnungen. Abschließender Pages-Build: 228,64 MB in 2625 Dateien, 22,86 Prozent des konservativen 1-GB-Budgets.
- Abschließend wieder für GitHub Pages gebaut. Nur lokale Commits, kein Push und keine Veröffentlichung.

## Netzwerk, OpenWebif, Entschlüsselung und Jugendschutz

- 21 neue Kapitel je Sprache; vorhandene LAN-, NFS-, SMB-, Freigabe- und Passwortkapitel ergänzt. Gesamtausgabe: 268 Inhalte je Sprache und 538 HTML-Dateien.
- Quellabgleich: Enigma2 `fdc9347241245fd18fd0b8bc93727237189c916c`; Netzwerk-, CI-, CAM- und Jugendschutz-Pythondateien entsprechen der installierten Paketrevision `c446c39a38957950de9989538e87c6278d2470cc`. Die Unterschiede der ganzen setup.xml/menu.xml betreffen andere Bereiche. Quellen und Hashes: `data/network-security-sources.json`.
- OpenWebif 2.4.0, `cacd3f69d065fb0eae326aebf456273dc957d2fa`; installierte setup.xml und Quellhash stimmen überein. Alle 23 Setupfelder und zusätzliche Browseroptionen erklärt. Der Dienstekatalog übernimmt alle 22 Einträge aus networkdaemons.xml mit eigener DE/EN-Erklärung.
- Aufnahmehelfer `b9b260f88baad3d12ee676e6383c53c4c4c009ab`: `network-security` mit 13 Szenen, endgültige Läufe `ns-b-de-network-security` und `ns-b-en-network-security`. Alle 26 nativen Bootlogo-Bilder einzeln geprüft; zusätzlich 16 geprüfte Browserbilder, je acht pro Sprache. Keine Zugangsdaten sichtbar. Verzeichnis/Manifest für Browserbilder getrennt von Enigma2-grab.
- Kein externer Feed und keine Softcam installiert. Der genannte Installer wurde nur als Text heruntergeladen und syntaktisch geprüft; aktueller HTTP-Redirect zu SusanOV/softcamfeed, HTTPS am ursprünglichen Host 404. Es erfolgte keine Vertrauenszusage und kein funktionaler Softcam-/CI+-Test.
- Beispiel-IP, DNS, Jugendschutz und OpenWebif-Auth/HTTPS nur auf abgetrennten Formularfeldern; Speichern, Dienstaktionen und PIN-Abfragen der Aufnahmeformulare gesperrt. Keine Adapter-Neustarts, Passwortänderungen, CAM-Resets, neuen Exporte oder Timer. Browsernavigation ohne Zappen, Speichern, Paket- oder Dateiveränderungen.
- Vor/nachher: 76 geschützte Pfadzustände verglichen, davon 75 identisch (Hash oder Abwesenheit); nur die komplette settings-Datei durch GUI-Neustarts neu geschrieben. Ausgewählte Konfiguration, IP-/Adapterzustand und erfasste Netzwerkpakete gleich. Originalsprache Deutsch, Skin sowie suspendierte EMC-/AutoTimer-Werte restauriert. Die Bestandsmounts, Kontodateien und privaten e2MDB-Daten blieben erhalten.
- Aufnahmehelper: 42 Python-Tests. Dokumentation: 11 Node- und 8 Python-Tests; Astro prüft 25 Dateien ohne Fehler, Warnungen oder Hinweise.
- Pages und Apache: jeweils 265 echte Pagefind-Prüfungen sowie Links, Assets, Sprungmarken und Sprachpaare bestanden. Ein englischer Suchtreffer für no_root_access wurde durch explizite Kurzschlüssel im Text verbessert; der Test wurde beibehalten.
- Sechs gebaute Seiten im Browser geprüft, alle darin enthaltenen Bilder geladen und Originalansichten angesehen. Mobile OpenWebif-Referenz bei 390 px ohne Seitenüberlauf. Keine universelle CI-, VPN-, DNSCrypt- oder sonstige Serverkompatibilität behauptet; WLAN und FBC bleiben spätere Hardwaretests.

## Bedienung / Oberfläche

- Alle 13 festen Menüeinträge erfasst; 225 bestehende Referenzeinträge weiterverwendet, mit vorhandenen und ergänzten Anleitungen verbunden. Zehn neue Kapitel pro Sprache. Vorhandene OSD-, Infobar-, Hotkey-, Skin- und Kanallistenkapitel ergänzt; deren URLs bleiben erhalten. Menügruppe, Startseite und Einstellungsverzeichnis verlinken den gemeinsamen Einstieg.
- `data/usage-gui-coverage.json` dokumentiert Menüeinträge, Quellstände und 225 existierende Referenzanker. Die zwölf geprüften Quellstellen entsprechen bei allen Pythondateien der installierten Paketrevision; ganze XML-Dateien unterscheiden sich in den zuvor erfassten fremden Bereichen. Keine zweite automatisch erzeugte Optionsreferenz.
- Aufnahmehelfer `307d35705e87db4349f5f32eb8226637fe7da4d3`; Profil `usage-gui`, endgültige Läufe `ui-a-de-usage-gui` und `ui-a-en-usage-gui`. 14 Bilder je Sprache vollständig, per SHA-256 geprüft und einzeln angesehen. Wiedergabe gestoppt, Bootlogo. Alle 28 Bilder werden verwendet.
- Formularbeispiele: Bildschirmschoner aktiviert, Aufwach-Workaround aktiviert, Mehrfachpfadmodus für Picons und Eingabegerätebearbeitung aktiviert. Konfigurationspfade und Eingabegeräte-/Picon-Bäume abgetrennt; aktive Treiber und Engine behalten originale Werte. Keine Schreibaktionen, Paketverwaltung, IR-Codeänderung oder physische Tastaturprüfung. Sprachlisten-Vorschau ohne Locale-Aktivierung; Paketcallback beim Schließen entfernt.
- Vor/nachher: 57 geschützte Pfadzustände, 56 identisch; nur die gesamte settings-Datei durch GUI-Neustarts neu geschrieben. Alle 30 erfassten Bedienungs-/Tuner-/Spracheinstellungen, komplette Paketliste und Mountliste identisch. Sender-, Timer- und private e2MDB-Daten erhalten, NAS und HDD weiter eingebunden. Deutsch und ursprüngliche EMC-/AutoTimer-Einstellungen wiederhergestellt.
- 43 Python-Tests des Aufnahmehelfers, 11 Node- und 8 Python-Tests der Dokumentation bestanden. Astro-Check: 25 Dateien ohne Fehler, Warnungen oder Hinweise.
- Apache unter `/` und GitHub Pages unter `/enigma2-doku`: jeweils 558 HTML-Dateien, Links, Bilder, Sprungmarken, Sprachpaare und 291 echte Pagefind-Prüfungen bestanden. 26 neue Suchprüfungen erfassen u.a. Picon search mode, Tastenintervalle, QWERTZ, 0x100, Langdruck-Kompatibilität und Screensaver.
- Acht gebaute Artikelseiten in beiden Sprachen mit vollständig geladenen Bildern im Browser geprüft und visuell angesehen. Mobile Übersicht bei 390 px ohne horizontalen Seitenüberlauf; breite Tabelle scrollt innerhalb ihres Bereichs.
- Neuer Gesamtbestand: 278 Inhalte und 125 bebilderte Kapitel je Sprache; 424 native Bilder, davon 398 mit Bootlogo und 26 frühere Sender-/EPG-Beispiele. Pages-Ausgabe 268,54 MB in 3032 Dateien (26,85 Prozent von 1 GB). Abschließend Pages-Ausgabe hergestellt. Nur lokale Commits.


## System und vollständiger Startassistent – 10. September 2026

- Neun neue Kapitel je Sprache: Systemübersicht, Swap, Flash Expander, Skriptverwaltung, Werkseinstellungen, HF-Ausgang, Quellen sowie vollständiger Startassistent und Anleitung zum erneuten Start. Die neun festen Endpunkte des Systemmenüs sind zugeordnet; 95 vorhandene Felder aus sieben Referenzen werden weiterverwendet. Bestehende Geräte-, CEC-, Zeit- und Log-Kapitel bleiben die jeweiligen Detailanleitungen.
- `data/system-coverage.json` erfasst Menüzuordnung, 15 Quellstellen mit Prüfsummen sowie 32 Start-, sieben Video- und zwei Sprachwizard-Quellschritte. Enigma2-Quelle `fdc9347241245fd18fd0b8bc93727237189c916c`, installierte Revision `c446c39a38957950de9989538e87c6278d2470cc`; verwendete Pythonquellen entsprechen dem installierten Stand. Bedingte Quellschritte sind nicht als 41 auf jeder Box sichtbare Seiten bezeichnet.
- Werkzeugstand `6c97fb5c8cbb56bf95a011c76c30a0c7e1533414`: getrennte native Systemformulare und rein beobachtende Erfassung des tatsächlich laufenden Erststarts. 46 Helfertests bestanden. Alle 58 neuen Bilder einzeln gesichtet und per Manifest-/Review-SHA-256 importiert: 44 aus den echten DE/EN-Wizardläufen und 14 aus `system-a-…-system-guides`. Zwei redundante Resetaufnahmen wurden nicht veröffentlicht.
- Tatsächlich ausgeführt: Settings bei gestopptem E2 umbenannt, Sprache und HDMI 1080p50 eingerichtet, LAN/DHCP bestätigt, DNS und vorhandene Mountpunkte geprüft, Zeit und einen verbundenen Astra-Eingang eingerichtet. Zusätzliche unverbundene Eingänge unkonfiguriert gelassen. Je Sprache ein automatischer Astra-Suchlauf ohne vorheriges Löschen, jeweils 1120 Dienste gefunden; anschließend normale InfoBar. Keine zusätzliche Abschlussseite erschienen. Manuellen Suchdialog nur angesehen, keine Standardliste installiert. Englische Konfigurationszeilen sind anders sortiert; ein zunächst falsch ausgewählter Suchzweig wurde korrigiert und dessen Fehlansicht nicht übernommen.
- Der Durchlauf erfolgte auf der vorhandenen Installation, ohne neues Flashen oder Slotwechsel. HDD und NAS bleiben erhalten; Mountdialog ohne Änderungen verlassen. Systemformulare mit gesperrten Aktionen: kein Werksreset, keine Formatierung, keine Swap-Änderung, keine Flash-Expander-Aktivierung und kein Skript ausgeführt. WLAN, FBC, HF-Modulator und SmallFlash-Sonderzweige sind keine abgeschlossenen Hardwaretests.

### Wiederherstellung der Testbox

- Vor dem erneuten Erststart wurden bei gestopptem E2 106 Konfigurationspfade samt Netzwerk-/Mountdateien und eine Paketliste gesichert. Archiv zusätzlich lokal und privat gespeichert; SHA-256 `618a7dbdfdf373baed54bc5e0f1036db220d4b609f88534982ac08392ed04a86`.
- Beim vorübergehenden Aussetzen automatischer Plugins wurden zunächst nur deren Einstiegsdateien ausgelagert. Die Enigma2-Pluginbereinigung entfernte daraufhin betroffene Pluginverzeichnisse. Dieser Fehler wurde dem Nutzer mitgeteilt und vor dem normalen Neustart behoben; das Vorgehen wird nicht als Reset-Anleitung weitergegeben.
- EMC, AutoTimer, EPGRefresh und EPGImport wurden aus den exakt bereits installierten Feedpaketen wiederhergestellt, ohne Paketupgrade oder Installationsskripte. Gesicherte Einstiegspunkte stimmen mit diesen Paketen überein. ProgrammlistenUpdater erhielt seine ergänzenden Dateien aus der installierten E2-Quellrevision und seinen ursprünglichen gesicherten Einstiegspunkt. e2MDB wurde aus dem unveränderten lokalen Quellstand `7442e3d04aac25c741fa96b370c22994131928e2` ergänzt; `plugin.py` ist identisch zur gesicherten Boxdatei, die ursprünglichen Einstiegspunkte wurden wiederhergestellt. Keine behauptete Bytegleichheit sämtlicher ergänzter Pluginmodule ohne ursprüngliches Vollarchiv.
- Noch bei gestopptem E2: alle 106 gesicherten Konfigurationspfade exakt wiederhergestellt, Paketliste unverändert, keine fehlenden paketzugehörigen Dateien in den betroffenen Verzeichnissen. Private Schlüssel- und Pfaddaten wurden erhalten. Danach normaler GUI-Neustart und erfolgreiche Systemserie in beiden Sprachen.
- Abschließend läuft E2 mit ursprünglichem Deutsch und MetrixHD; Beobachter deaktiviert, EMC-/AutoTimer-Schutzwerte restauriert. Paketliste und komplette Mountliste unverändert. 101 der 106 Pfadzustände bytegleich. Die fünf Laufzeitabweichungen sind MetrixWeather-Cache, EPG-Cache, e2MDB-settings-Zeitstempel `updated`, Schedulerdatei und E2-Settings. In den E2-Settings unterscheiden sich ausschließlich `config.misc.nextWakeup`, `config.misc.startCounter` und `config.usage.shutdownOK`; sämtliche übrigen gespeicherten Werte einschließlich Tuner, Sprache und Automatikoptionen stimmen überein. Beide Scheduler-Aufgaben haben unveränderte Attribute; eine enthält zusätzliche Protokolleinträge. Keine Bytegleichheit aller Dateien im laufenden Betrieb behauptet.


### Website-Prüfungen für System und Erststart

- 11 Node- und 8 Python-Tests der Dokumentation bestanden; Astro-Check prüfte 25 Dateien ohne Fehler, Warnungen oder Hinweise. Aufnahmehelfer: 46 Tests.
- GitHub Pages unter `/enigma2-doku` und Apache unter `/`: jeweils 576 HTML-Dateien einschließlich interner Links, Assets, Sprungmarken, Sprachpaare und 313 echter Pagefind-Suchprüfungen erfolgreich. 22 neue Fälle prüfen System- und Wizardbegriffe. Zwei zunächst ungültige EPG-Verweise wurden auf das Grundlagenkapitel korrigiert. Die kurzen Dateinamen `autotimer.xml` und `scheduler.xml` stehen nun ausdrücklich in ihren bisherigen Fachkapiteln, damit die Suchtests trotz neuer Vorkommen im Resetkapitel dieselben Fachanleitungen finden.
- Alle 18 neuen Artikelseiten im gebauten Browser geprüft; sämtliche 58 neuen Artikelbilder laden und lassen sich dekodieren. Deutsche/englische Systemansichten und Wizardansichten visuell angesehen. Drei mobile Seiten bei 390 px ohne horizontalen Seitenüberlauf: Systemübersicht, vollständiger Wizard und Settings-Wiederherstellung.
- Neuer Gesamtbestand: 287 Inhalte pro Sprache, 482 native PNGs (412 Bootlogo-Systemansichten, 26 frühere Sender-/EPG-Beispiele und 44 echte Wizardaufnahmen). Alle neuen Bilder werden in der jeweiligen Sprachfassung verwendet. Websitegröße: 286,02 MB in 3300 Dateien, 28,60 Prozent des konservativen 1-GB-Budgets.
- Abschließend wieder für GitHub Pages gebaut. Nur lokale Commits; kein Push und keine Veröffentlichung. Die Arbeiten mit dieser Testbox sind abgeschlossen; WLAN und FBC folgen mit der nächsten Box.


## FBC und WLAN – Konfigurationsserie vom 10.09.2026

- Neue Testhardware: ein SAT-FBC-Block mit acht Demodulatoren und zwei Eingängen, ein Kabel-FBC-Block mit acht Demodulatoren sowie ein WLAN-Adapter mit vorhandenem Profil. Image OpenATV 8.0.0-beta; installierte E2-Quellrevision `77874189f00c32f32ef96ecfc73dab3f53da5f13`. Die Artikel bleiben geräteneutral.
- Umfang: die drei bisherigen Platzhalter/Einstiegsseiten für SAT-FBC, Kabel-FBC und WLAN ersetzt/erweitert; zwei zusätzliche SAT-FBC-Kapitel für Universal-Zuführungen und Unicable. Je Sprache fünf ausführliche Kapitel. Dazu Navigation, Empfangs-/Netzwerkübersichten und Quellen aktualisiert.
- Freigegeben: 22 native FBC-Bilder und acht WLAN-Bilder in DE/EN. Die leere WLAN-Suchansicht ist auf Nutzerwunsch nicht enthalten. Schlüssel schon vor der Konstruktion des nativen Formulars ersetzt und zusätzlich mit schwarzem Widget verdeckt. Alle 30 Originalbilder einzeln bzw. in lesbarer Galerie angesehen; die abschließende WLAN-Übersicht zeigt den ausgewählten WLAN-Adapter und seine echte Profilliste.
- Sechs neue originale Verkabelungsszenarien, jeweils DE/EN-SVG: ein Universal-Kabel, zwei unabhängige Universal-Kabel, Unicable mit acht UBs, zwei feste Positionen, feste plus separate Motorantenne sowie DVB-C FBC. Textgrenzen aller zwölf SVGs im Browser geprüft und Darstellungen visuell angesehen. Die abschließende Zwei-Kabel-Zeichnung unterscheidet A=HL und B=VH von den flexibel zugeordneten C–H.
- Nach expliziter Freigabe aller acht Userbänder G von SCR 6 auf SCR 7 / 1980 MHz und H von SCR 7 auf SCR 8 / 2096 MHz berichtigt. Die Bilder zeigen eindeutige SCRs 1–8. Universal-/Gleich-wie-/FBC-Automatik-Bilder sind nicht gespeicherte Formularbeispiele.
- Der Nutzer bestätigte, dass für diesen Auftrag Konfiguration genügt und kein SAT-Kabel angeschlossen ist. Entsprechend kein erfolgreicher RF-/Parallelaufnahmetest behauptet. WLAN-Verbindungsaufbau und Profilwechsel sind erklärt, nicht als erfolgreich ausgeführte Tests ausgewiesen. WPA3 und WPA2/WPA3 sind im Quellcode geprüft. Mehrere Profile pro Adapter, Priorität und gezielter Wechsel werden beschrieben. WPA3-Enterprise enthält nur eine kurze Erklärung von 802.1X/EAP, RADIUS und Zertifikats-/Schlüsselbedarf; Einrichtung erfolgt außerhalb der GUI nach IT-Vorgaben.
- Wiederherstellungsprüfung: 86 archivierte Dateipfade geprüft, davon 83 unverändert. Unterschiede: Wettercache, EPG-Cache und E2-Settings. In den Settings unterscheiden sich die vier autorisierten SCR/Frequenzeinträge sowie `nextWakeup`, `startCounter`, `shutdownOK` und zwei abgeleitete Datumsformatwerte. WLAN-Profile, Netzwerk-, Mount- und Kontokonfiguration blieben unverändert. GUI abschließend bereit in Deutsch. Private Originalkonfiguration und Rohaufnahmen bleiben unter dem ignorierten `.capture-private`.
- Aufnahmehelfer lokal committet: `fc939f97ab0a487fdd93d7c7fdaa85c6d4b1895a`; 34 Profile, 240 Szenen, 48 bestandene Python-Tests. Dokumentation: elf Node-Tests einschließlich der nun 512 freigegebenen PNGs und acht Python-Tests bestanden. Astro-Check: 25 Dateien, keine Fehler/Warnungen/Hinweise.
- GitHub Pages unter `/enigma2-doku` und Apache unter `/` gebaut: jeweils 580 HTML-Dateien mit gültigen lokalen Links, Assets, Sprungmarken und Sprachpaaren. Jeweils 335 tatsächliche Pagefind-Suchprüfungen bestanden, darunter 22 neue FBC-/WLAN-Fälle.
- Browser: alle zehn neuen/überarbeiteten Kapitel geprüft; 42 eingebundene Artikelbilder (30 Screenshots plus zwölf SVG-Verwendungen) erfolgreich dekodiert. Alle zehn Seiten bei 390 px ohne horizontalen Seitenüberlauf. Deutsche Unicable-Ansicht, englische WLAN-Ansicht und beide mobile Beispiele zusätzlich visuell angesehen.
- Endstand: 289 Inhalte pro Sprache, 512 native PNGs; veröffentlichter Build 291,30 MB in 3442 Dateien, 29,13 Prozent des konservativen 1-GB-Budgets. Abschließend wieder mit GitHub-Pages-Basispfad gebaut. Nur lokale Commits, kein Push und keine Veröffentlichung.
