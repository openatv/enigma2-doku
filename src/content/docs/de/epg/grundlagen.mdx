...
## Weiter mit Ansichten, Quellen und Timern

- [EPG-Ansichten und Primetime](../ansichten/): einfacher, Single-, Multi-, grafischer, vertikaler und Infobar-EPG mit ARD-/ZDF-Beispielen.
- [INFO, EPG und Langdruck anpassen](../tasten/): die passende Ansicht direkt öffnen.
- [EPGRefresh](../../addons/epgrefresh/): DVB-Daten automatisch einsammeln.
- [EPGImport](../../addons/epgimport/): XMLTV-Quellen und Importtage einrichten.
- [Fehlende Daten und IPTV-Zuordnung](../fehlende-daten/): Service-Reference und Kanal-ID prüfen.
- [Aufnahmetimer](../../timer/aufnahmen/) und [Zeit/NTP/Aufwachen](../../system/zeit-aufwachen/): aus Programminformationen einen verlässlichen Plan machen.
