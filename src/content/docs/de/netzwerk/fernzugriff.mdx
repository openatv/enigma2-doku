...
Das root-Passwort schützt nicht automatisch alle Dienste: [OpenWebif-Anmeldung](../openwebif/sicherheit/) aktivieren, [Samba-Benutzer](../samba-server/) getrennt prüfen. [Alle Netzwerkdienste](../dienste/) erläutert Installation, Start/Stopp und Autostart. Der [Enigma2-Jugendschutz-PIN](../../entschluesselung/jugendschutz/) ist unabhängig davon.
