...
Die [Verkabelungsbilder](../verkabelung/) zeigen die Anschlüsse. Für mehrere Satelliten, Einkabelanlagen, Motor und Kabel-/Antennenempfang führt die [Empfangsübersicht](../) zu den passenden Kapiteln. Verwende die Daten deiner eigenen Installation.
...
Details und Tasten: [automatischer Suchlauf](../automatischer-suchlauf/), [manueller Suchlauf](../manueller-suchlauf/) und [Signalfinder](../signalfinder/).
