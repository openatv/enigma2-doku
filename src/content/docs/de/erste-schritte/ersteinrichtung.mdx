...
| Dein nächster Schritt | Anleitung |
| --- | --- |
| Den gesamten Assistenten mit Bildern durchlaufen | [Sprache bis Suchlauf und Abschluss](../startassistent/) |
| Den Erststart auf einer Testbox wiederholen | [Enigma2 stoppen, Settings umbenennen und wiederherstellen](../assistent-neustarten/) |
| Einzelne Systemfunktionen später ändern | [System und alle Unterpunkte](../../system/) |

Diese Einstiegsseite gibt den Überblick. Der ausführliche Ablauf enthält die tatsächlichen deutschen und englischen Aufnahmen sowie Erklärungen zu jedem Schritt und zu hardwareabhängigen Zusatzseiten.
...
Quelle: [OpenATV-Ersteinrichtungsassistent](https://github.com/openatv/enigma2/blob/fdc9347241245fd18fd0b8bc93727237189c916c/data/startwizard.xml). Zusätzlich zu den frühen Einzelansichten wurde der vollständige Ablauf nach Umbenennen der Settings auf der Testbox durchgeführt. Das ist kein neuer Flashvorgang; installierte Pakete und vorhandene Laufwerke blieben erhalten. [Prüfumfang und Quellen](../../system/quellen/).
