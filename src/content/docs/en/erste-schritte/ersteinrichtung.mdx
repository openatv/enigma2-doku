...
Source: [OpenATV first-run wizard](https://github.com/openatv/enigma2/blob/fdc9347241245fd18fd0b8bc93727237189c916c/data/startwizard.xml). The illustrated wizard pages were captured on a running OpenATV 8.0 installation. They verify the individual views; a complete run after a fresh installation still needs separate testing.
