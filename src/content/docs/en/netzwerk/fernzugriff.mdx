...
The root password does not automatically protect every service: enable [OpenWebif authentication](../openwebif/sicherheit/) and check [Samba users](../samba-server/) separately. [Network services](../dienste/) explains installation, start/stop and autostart. The [Enigma2 parental PIN](../../entschluesselung/jugendschutz/) is separate.
