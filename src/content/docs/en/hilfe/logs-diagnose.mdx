...
TV/AVR power, input selection and volume-key problems have a separate [daily HDMI-CEC log](../../bild-ton/cec-logs/). That chapter explains its own debug switch, filename and how to interpret control traffic.
