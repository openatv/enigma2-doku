...
You do not need a new settings package to change the appearance: [Channel list – MENU, settings and all styles](../kanalliste/) illustrates the classic and new layouts.
