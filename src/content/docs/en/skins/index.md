...
1. Install an additional skin through [plugin management](../plugins/installieren/) if it is not already present.
2. Open Skin Settings and select an installed skin.
3. Check the offered preview and confirm using the labelled action.
4. Perform a GUI restart if requested.

Some skins provide their own configuration plugins. Their options belong to those plugins and are not necessarily available in the general skin selection screen.

## What belongs where?

- **Skin:** Appearance and layout of the interface.
