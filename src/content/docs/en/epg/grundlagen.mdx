...
## Continue with views, sources and timers

- [EPG views and prime time](../ansichten/): simple, single, multi, graphical, vertical and InfoBar EPG with ARD/ZDF examples.
- [Configure INFO, EPG and long presses](../tasten/): open the appropriate view directly.
- [EPGRefresh](../../addons/epgrefresh/): collect DVB data automatically.
- [EPGImport](../../addons/epgimport/): configure XMLTV sources and import days.
- [Missing data and IPTV mapping](../fehlende-daten/): check service references and channel IDs.
- [Recording timers](../../timer/aufnahmen/) and [time/NTP/wakeup](../../system/zeit-aufwachen/): turn programme information into a reliable schedule.
